...
class Pokemon {
  ...
  clone(): Pokemon {
    ...
    return new Pokemon(this.name, this.type, this.level, [...this.attacks]); // importante el [...this.attacks], para clonar el array, para evitar que se modifique el array original
  }
